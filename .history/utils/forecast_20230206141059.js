...
const forecast = ( latitude, longtitude, callback ) => {
  ...
  request( {
    ...
    if ( error ) {
      ...
      callback( undefined, response.body.current.weather_descriptions[ 0 ] + ". It is currently " + body.current.temperature + " degrees out. There is " + body.current.precip + " of rain." )
    }
